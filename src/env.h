...
#define PER_ISOLATE_STRING_PROPERTIES(V)                                      \
  ...
  V(get_string, "get")                                                        \
  V(get_data_clone_error_string, "getDataCloneError")                         \
  V(gid_string, "gid")                                                        \
  ...
  V(raw_string, "raw")                                                        \
  V(read_host_object_string, "readHostObject")                                \
  ...
  V(write_array_buffer_view_string, "writeArrayBufferView")                   \
  V(write_host_object_string, "writeHostObject")                              \
