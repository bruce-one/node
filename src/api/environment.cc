...
Environment* CreateEnvironment(
  ...
  Environment* env = new Environment(
      ...
      flags,
      thread_id);
  if (flags & EnvironmentFlags::kDoNotAbortOnUncaughtException) {
...
MaybeLocal<Value> LoadEnvironment(
  ...
  switch (start_profiler_idle_notifier) {
    case ProfilerIdleNotifierMode::kStart:
      env->InitializeLibuv(false);
      break;
    case ProfilerIdleNotifierMode::kDoNotStart:
      env->InitializeLibuv(false);
      break;
    case ProfilerIdleNotifierMode::kDefault:
