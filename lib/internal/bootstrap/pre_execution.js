...
// TODO(addaleax): Remove the flag guarding against a double run of this,
// it's only needed because of lib/internal/bootstrap/environment.js
// which should also be removed (because the legacy `CreateEnvironment()`
// also runs this file in addition to `LoadEnvironment()`, and the former
// shouldn't).
let ranPrepareMainThreadExecution = false;
function prepareMainThreadExecution(expandArgv1 = false) {
  if (ranPrepareMainThreadExecution) return;
  ranPrepareMainThreadExecution = true;
