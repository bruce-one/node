...
const win32 = {
  ...
  resolve: function resolve() {
    if (arguments.length <= 2) {
      if (arguments.length >= 1) assertPath(arguments[0]);
      if (arguments.length >= 2) assertPath(arguments[1]);
      return uv.path_win32_resolve(arguments[0] || null, arguments[1] || null);
    }
    var resolvedDevice = '';
    var resolvedTail = '';
...
const posix = {
  ...
  resolve: function resolve() {
    if (arguments.length <= 2) {
      if (arguments.length >= 1) assertPath(arguments[0]);
      if (arguments.length >= 2) assertPath(arguments[1]);
      return uv.path_posix_resolve(arguments[0] || null, arguments[1] || null);
    }
    var resolvedPath = '';
    var resolvedAbsolute = false;
    var cwd;
